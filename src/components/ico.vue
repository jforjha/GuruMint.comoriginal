...
import {initRoadmap} from '../js/libs/components/roadmap'
import {initBackToTop} from '../js/libs/components/backtotop'
import {initCountdown} from '../js/libs/components/countdown'
import {initTabs} from '../js/libs/components/tabs'
import {initSidebar} from '../js/libs/components/sidebar'
import {env,themeColors,demoData } from '../js/libs/utils/constants'
import {switchDemoImages, getUrlParams,insertBgImages} from '../js/libs/utils/utils'
import { initHero} from '../js/libs/components/hero'
export default {
    methods(){
initRoadmap();
initBackToTop;
...
@import "../scss/utilities/_utils.scss"
