<template>
  ...
  <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
	...
	<!--Main Col-->
	<div id="profile" class="w-full lg:w-2/4 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-5 lg:mx-0">
	...
	<div class="w-full lg:w-2/6">
		...
		<img style="height:700px;margin:10%" src="https://source.unsplash.com/MP0IUfwrn0A" class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block">
